...
> Step 2
:- Inside VSCode Install "samyakpack2" Extension (Press <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>X</kbd> to Open Extension's)
...
> Step 5 :- Install a Nice Font that You Like (I Use OperatorMono-Book-Italic:- "**Operator Mono**")
